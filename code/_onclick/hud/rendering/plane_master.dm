...
//Plane for masking spooky stuff
/atom/movable/screen/plane_master/spectral
	name = "spectral plane master"
	plane = SPECTRAL_TRESPASS_PLANE
	mouse_opacity = MOUSE_OPACITY_TRANSPARENT
	render_target = SPECTRAL_TRESPASS_PLANE_RENDER_TARGET
	render_relay_plane = null
//Psychic & Blind stuff
