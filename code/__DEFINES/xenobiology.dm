...
#define XENOB_SUB_MASKS list("nothing, you big fucking nerd" = XENOB_COMMON, "m_tumor" = XENOB_UNCOMMON, "m_shogun" = XENOB_UNCOMMON, "m_hat" = XENOB_RARE, "m_halo" = XENOB_RARE)
...
#define XENOB_INSTABILITY_MOD 15

///slime mutation costs
#define XENOB_MUTATE_MINOR 25
#define XENOB_MUTATE_MEDIUM 30
