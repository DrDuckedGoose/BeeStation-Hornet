...
#define PLANT_FRUIT_GROWTH_SLOW 1//60 SECONDS
#define PLANT_FRUIT_GROWTH_MEDIUM 1//30 SECONDS
#define PLANT_FRUIT_GROWTH_FAST 1//20 SECONDS
#define PLANT_FRUIT_GROWTH_VERY_FAST 1//5 SECONDS
