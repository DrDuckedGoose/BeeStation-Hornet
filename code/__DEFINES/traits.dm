...
#define TRAIT_POSSESSED "possessed" //This mob is possesssed
#define TRAIT_INDIANA_JONES "drjones" //This mob can use curios
...
#define TRAIT_FUNERAL_GARNISH	"garnish" //For funerals and rot effects
