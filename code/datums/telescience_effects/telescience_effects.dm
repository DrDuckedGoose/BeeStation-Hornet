...
/datum/telescience_effect/proc/action(/obj/structure/teleporter_door/T)
	return
...
/datum/telescience_effect/incurson/action(obj/structure/teleporter_door/T)
...
/datum/telescience_effect/fire/action(obj/structure/teleporter_door/T)
