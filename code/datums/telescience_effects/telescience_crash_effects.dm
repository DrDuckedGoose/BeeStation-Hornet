//These are effects for collapsing or bad access of portals
/datum/telescience_crash_effect
	///Name for incident record
	var/name
	///Description for incident record
	var/desc

/datum/telescience_crash_effect/proc/action(/obj/structure/T)
	return

// ===== Monster spawner =====
/datum/telescience_crash_effect/incurson
...
/datum/telescience_crash_effect/incurson/action(obj/structure/T)
	product_entity = new(get_turf(T))

// ===== Fire =====
/datum/telescience_crash_effect/fire
	name = "Pyrodimensional Eruption"
	desc = "A wave of heat has erupted from the portal."
	///Size of fire
	var/size = 3

/datum/telescience_crash_effect/fire/action(obj/structure/T)
...
// ===== Fire BEEEG =====
/datum/telescience_crash_effect/fire/big
