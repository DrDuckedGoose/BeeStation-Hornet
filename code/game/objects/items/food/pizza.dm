...
/obj/item/food/pizza/make_processable()
	if(slice_type)
		AddElement(/datum/element/processable, TOOL_KNIFE, list(slice_type = 3), 3 SECONDS, table_required = TRUE, /*screentip_verb = "Slice"*/)
		AddElement(/datum/element/processable, TOOL_SAW, list(slice_type = 6), 4.5 SECONDS, table_required = TRUE, /*screentip_verb = "Slice"*/)
		AddElement(/datum/element/processable, TOOL_SCALPEL, list(slice_type = 6), 6 SECONDS, table_required = TRUE, /*screentip_verb = "Slice"*/)
