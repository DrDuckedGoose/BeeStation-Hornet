...
/mob/living/silicon/robot_old/proc/uneq_module(obj/item/O)
	if(!O)
		return 0
...
/mob/living/silicon/robot_old/proc/activate_module(obj/item/O)
	. = FALSE
...
/mob/living/silicon/robot_old/proc/observer_screen_update(obj/item/I,add = TRUE)
	if(observers?.len)
...
/mob/living/silicon/robot_old/proc/activated(obj/item/O)
	if(O in held_items)
		return TRUE
	return FALSE
...
/mob/living/silicon/robot_old/proc/module_selected(module) //Module is 1-3
	return module == get_selected_module()

//module_active(module) - Checks whether there is a module active in the slot specified by "module".
/mob/living/silicon/robot_old/proc/module_active(module) //Module is 1-3
...
/mob/living/silicon/robot_old/proc/select_module(module) //Module is 1-3
	if(module < 1 || module > 3)
		return
...
/mob/living/silicon/robot_old/proc/deselect_module(module) //Module is 1-3
	if(module < 1 || module > 3)
		return
...
/mob/living/silicon/robot_old/proc/toggle_module(module) //Module is 1-3
	if(module < 1 || module > 3)
		return
