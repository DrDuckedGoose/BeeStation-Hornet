/mob/living/silicon/new_robot/deadchat_lawchange()
	if(law_update)
		return
	..()

/mob/living/silicon/new_robot/show_laws(everyone = 0)
	laws_sanity_check()
//Who are we showing these laws to
	var/who
	if(everyone)
		who = world
	else
...
//Show the laws to who it concerns
	to_chat(who, "<b>Obey these laws:</b>")
	laws.show_laws(who)
//Disclaimer to remind the player how to behave
	if(get_shell()) //AI shell
...
/mob/living/silicon/new_robot/post_lawchange(announce = TRUE)
	. = ..()
