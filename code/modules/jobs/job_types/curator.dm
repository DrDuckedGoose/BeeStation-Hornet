/datum/job/curator
	...
	access = list(ACCESS_LIBRARY, ACCESS_AUX_BASE, ACCESS_MINING_STATION, ACCESS_MAINT_TUNNELS, ACCESS_THEATRE)
	minimal_access = list(ACCESS_LIBRARY, ACCESS_AUX_BASE, ACCESS_MINING_STATION, ACCESS_MAINT_TUNNELS, ACCESS_THEATRE)
