...
//Chaplain objectives
/datum/objective/crew/chaplain_litany
...
/datum/objective/crew/chaplain_litany/New()
	. = ..()
	//TODO: Implement other target types - Racc
	litany_target = pick(GLOB.areas)
...
/datum/objective/crew/chaplain_litany/update_explanation_text()
	. = ..()
	explanation_text = "Bless [litany_target] with a litany containing"
	for(var/i in litany_components)
		explanation_text = "[explanation_text] [i], "

/datum/objective/crew/chaplain_litany/check_completion()
	if(..())
		return TRUE
