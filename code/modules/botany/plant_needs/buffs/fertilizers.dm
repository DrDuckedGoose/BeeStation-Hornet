...
/datum/plant_need/reagent/buff/robust
	...
	reagent_needs = list(/datum/reagent/plantnutriment/robustharvestnutriment = 5, /datum/reagent/saltpetre = 2)
	auto_threshold = TRUE
...
/datum/plant_need/reagent/buff/heal/tier_1
	reagent_needs = list(/datum/reagent/plantnutriment/eznutriment = 5, /datum/reagent/consumable/nutriment = 5)
	restore = 0.1
...
/datum/plant_need/reagent/buff/heal/tier_3
	reagent_needs = list(/datum/reagent/plantnutriment/slimenutriment = 1, /datum/reagent/water/holywater = 2, /datum/reagent/medicine/cryoxadone = 1.5)
	restore = 0.5
