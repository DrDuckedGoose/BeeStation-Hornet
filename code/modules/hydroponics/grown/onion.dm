...
/obj/item/food/grown/onion/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/onion_slice = 2), 15)
...
/obj/item/food/grown/onion/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/onion_slice/red = 2), 15)
